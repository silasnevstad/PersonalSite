...
const projectsData = [
  ...
  { id: '12',  requests: 0, title: 'BuddyAI', date: 'May 2023', languages: 'React | Python', logo: 'buddyLogo.png', description: 'Your personal AI co-writer. Have buddy write along with you, suggesting continutations, formalizing your text, improving it or just simply ask it questions. This app is hosted using React and uses a python API hosted on Heroku.', developers: 'Silas Nevstad', version: '1.0.0', url: 'buddyai.me' },
