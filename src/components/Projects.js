...
const projectsData = [
  ...
  { id: '5', requests: 4170, title: 'Scramdleb', date: 'Mar 2023', languages: 'React | Node.js', logo: 'scramdlebLogo.png', description: 'Scrambled is a word puzzle game where players shift letters to form a secret word within a limited number of moves. The game offers different difficulty levels with varying word lengths and number of moves, making it a fun and challenging game for players of all skill levels.', developers: 'Silas Nevstad', version: '2.0.1', url: 'https://scramdleb.com' },
